  ...
  return (
   <SafeAreaView className = "bg-primary h-full">
    ...
    <View className ="w-14 h-14 border border-dashed border-secondary-100 justify-center items-center" >
      ...
      <Text className =" text-base text-gray-100 font-pmedium" >THumnail Image</Text>
    ...
    <View className = "w-full h-20 px-4 bg-black-100 rounded-2xl justify-center items-center border-2 border-black-200 flex-row space-y-2">
